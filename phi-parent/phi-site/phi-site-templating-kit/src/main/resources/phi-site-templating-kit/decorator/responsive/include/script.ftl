<script type="text/javascript" src="${contextPath}/phi-js/static/js/lib/ext/jquery/jquery-2.1.1.js"></script>

<script type="text/javascript" src="${contextPath}/phi-js/static/js/lib/phi/phi.core.js"></script>
<script type="text/javascript" src="${contextPath}/phi-js/static/js/lib/phi/phi.dom.js"></script>
